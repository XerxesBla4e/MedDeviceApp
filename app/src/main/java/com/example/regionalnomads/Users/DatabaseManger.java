package com.example.regionalnomads.Users;
...
public class DatabaseManger {
    ...
    public android.database.Cursor fetch() {
        ...
        android.database.Cursor cursor = sqLiteDatabase.query(DatabaseHelper.TABLE_NAME, columns, null, null, null, null, null);
